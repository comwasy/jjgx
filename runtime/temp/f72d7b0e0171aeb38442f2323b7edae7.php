<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/goods\_goods.html";i:1515922293;s:44:"./application/admin/view2/public\layout.html";i:1515953439;}*/ ?>
<!doctype html>
<html>
<head>
...
<script src="__PUBLIC__/js/global.js"></script>
    ...
    function get_help(obj){
		...
		window.open("http://www.jjgx365.com/");
		return false;
...
<!--通用信息-->
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="record_no">商品专区</label>
                </dt>
                <dd class="opt">
                    <?php if(is_array($prefecture_list) || $prefecture_list instanceof \think\Collection || $prefecture_list instanceof \think\Paginator): if( count($prefecture_list)==0 ) : echo "" ;else: foreach($prefecture_list as $k=>$v): ?>
                        <input name="prefecture_ids[]" type="checkbox" value="<?php echo $v['id']; ?>"  <?php if(in_array($v['id'],$goods_prefecture_ids)): ?>checked="checked"<?php endif; ?> /><?php echo $v['name']; endforeach; endif; else: echo "" ;endif; ?>
                </dd>
            </dl>
            <!--<dl class="row">-->
                <!--<dt class="tit">-->
                    <!--<label for="record_no">推荐会员手机号码</label>-->
                <!--</dt>-->
                <!--<dd class="opt">-->
                    <!--<input type="text" value="<?php echo $goodsInfo['recommend_mobile']; ?>" name="recommend_mobile" id="recommend_mobile" class="input-txt"/>-->
                    <!--<span class="err" id="err_recommend_mobile" style="color:#F00; display:none;"></span>-->
                <!--</dd>-->
            <!--</dl>-->
            <!--dl class="row">
                <dt class="tit">
                ...
                <dd class="opt">
                  ...
                  <select name="extend_cat_id_3" id="extend_cat_id_3" class="small form-control">
                    ...
                    <span class="err" id="err_extend_cat_id" style="color:#F00; display:none;"></span>
                </dd>
            </dl -->
            <dl class="row">
                <dt class="tit">
...
<script>
    ...
    $(function(){
        $(document).on("blur",'#recommend_mobile',function(){
            var bool = false;
            bool = checkMobile($(this).val());
            if(bool == false){
                layer.open({
                    title: '信息提示：'
                    ,content: '推荐会员手机号码格式错误！'
                    ,icon:2
                });
            }
        })
