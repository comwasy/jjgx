...
class Goods extends Base {
    ...
    */ 
    public function goodsInfo(){
	    ...
	    $goods_prefecture_ids = M('goods_prefecture')->field('id,name')->where($map)->select();
	    foreach ($goods_prefecture_ids as $val){
		    $prefecture_ids[] = $val['id'];
	    }
        ...
        $this->assign('goods_prefecture_ids',$goods_prefecture_ids);//商品专区
